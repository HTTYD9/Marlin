...
#define PS_ON_PIN                           PF5  
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define POWER_TIMEOUT              480 // (s) Turn off power if the machine is idle for this duration
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 418.45
  #define DEFAULT_bedKi 78.07
  #define DEFAULT_bedKd 1495.26
